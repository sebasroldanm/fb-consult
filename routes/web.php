...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/colombia', DatainfoTable::class)->name('colombia');
    Route::post('/colombiaSearch', function (Request $request) {
    ...
    Route::get('/contactar', [EmailQueueController::class, 'contact'])->name('contact');
    Route::post('/queueProccess', [EmailQueueController::class, 'queueProccess'])->name('queueProccess');
});
...
// Route::middleware(['auth:sanctum', 'verified'])
//     ->get('/contactar', [EmailQueueController::class, 'contact'])
//     ->name('contact');

// Route::middleware(['auth:sanctum', 'verified'])
//     ->post('/queueProccess', [EmailQueueController::class, 'queueProccess'])
//     ->name('queueProccess');
